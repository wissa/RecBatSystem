...
void onI2CRequest() {
  ...
  Wire.write((byte*)&currentTemperatureC, sizeof(currentTemperatureC));
  Wire.write((byte*)&currentVcc, sizeof(currentVcc));

  // int16_t tempInt = (int16_t)(currentTemperatureC * 100);
  // Wire.write((uint8_t)(tempInt >> 8));
  // Wire.write((uint8_t)(tempInt & 0xFF));

  // // Vcc in mV for better resolution
  // uint16_t vccInt = (uint16_t)(currentVcc * 1000);
  // Wire.write((uint8_t)(vccInt >> 8));
  // Wire.write((uint8_t)(vccInt & 0xFF));
